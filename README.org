...
(use-package general
  ...
  ;;  "h" 'eshell-previous-matching-input-from-input
  ;;  "l" 'eshell-next-matching-input-from-input)
...
(use-package treesit-auto
  ...
  (setq treesit-auto-langs '(bash elisp nix python go java)
...
;; better undo with session support
(use-package undo-fu)
